...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT(
    //,----------------------+-----------------------+-----------------------+-----------------------+-----------.                                          ,-----------------------+-----------------------+-----------------------+-----------------------+-------------------------.
        KC_INSERT,              KC_NO,                  CW_TOGG,                KC_CAPS,                KC_NO,                                                 LCTL(KC_LEFT),          LCTL(KC_DOWN),          LCTL(KC_UP),            LCTL(KC_RIGHT),         KC_BSPC,
    //|----------------------+-----------------------+-----------------------+-----------------------+-----------|                                          |-----------------------+-----------------------+-----------------------+-----------------------+-------------------------|
        KC_LEFT_GUI,            MT(MOD_LALT, KC_ESCAPE),MT(MOD_LCTL, KC_TAB),   MT(MOD_LSFT, KC_ENTER), KC_BSPC,                                               KC_LEFT,                MT(MOD_RSFT, KC_DOWN),  MT(MOD_RCTL, KC_UP),    MT(MOD_LALT, KC_RIGHT), MT(MOD_RGUI, KC_ENTER),
    //|----------------------+-----------------------+-----------------------+-----------------------+-----------|                                          |-----------------------+-----------------------+-----------------------+-----------------------+-------------------------|
        KC_RIGHT_ALT,           KC_NO,                  KC_NO,                  KC_NO,                  KC_NO,                                                 KC_HOME,                KC_PGDN,                KC_PAGE_UP,             KC_END,                 MT(MOD_RALT, KC_TAB),
    //|----------------------+-----------------------+-----------------------+-----------------------+-----------|                                          |-----------------------+-----------------------+-----------------------+-----------------------+-------------------------|
                                                                                                        TO(0),     TT(4),                   TT(4),             MO(6)
                                                                                                   //`-----------+-----------------´      `-----------------+---------´
    ),
